  ...
  return (
    <div className="flex min-h-[100dvh] flex-col max-w-screen">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="w-full h-screen py-20 md:py-32 lg:py-40 overflow-hidden bg-[url('/hero6.png')] bg-center bg-cover bg-no-repeat">
          ...
          <motion.div
            ...
            >
              ...
              Vibrant, ready-to-use gradient backgrounds that make your landing pages stand out
              </p>
